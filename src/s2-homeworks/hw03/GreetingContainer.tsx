...
export const pureAddUser = (name: string, setError: any, setName: any, addUserCallback: {name: string}) => {
...
export const pureOnEnter = (e: KeyboardEvent<HTMLButtonElement>, addUser: any) => { // если нажата кнопка Enter - добавить
}
